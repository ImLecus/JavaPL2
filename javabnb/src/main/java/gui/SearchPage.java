...
public class SearchPage extends javax.swing.JPanel implements DynamicPage {
    ...
    private void initComponents() {
        ...
        orderByComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Precio", "Estrellas", "Casas - Apartamentos", "Apartamentos - Casas" }));
    ...
    private void orderByComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderByComboBoxActionPerformed
        String selectedItem = (String) orderByComboBox.getSelectedItem();
        switch (selectedItem) {
            case "Precio" -> {
                SearchEngine.sortBy = SortType.PRICE; 
            }
            case "Estrellas" -> {
                SearchEngine.sortBy = SortType.STARS;
            }
            case "Casas - Apartamentos" -> {
                SearchEngine.sortBy = SortType.HOUSE;
            }
            case "Apartamentos - Casas" -> {
                SearchEngine.sortBy = SortType.APARTMENT; 
            }
            default -> {} 
        }
        SearchEngine.sortSearch(SearchEngine.results);
        App.redirect("SEARCH");
        
        System.out.println(String.valueOf(SearchEngine.sortBy));
